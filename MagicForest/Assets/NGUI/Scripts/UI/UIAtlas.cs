...
public class UIAtlas : MonoBehaviour
{
  ...
  // Whether the atlas is using a alpha texture. -1 = not checked. 0 = no. 1 = yes.
  int mUseAlphaTexture = -1;
  ...
  /// <summary>
  /// Whether the atlas is using a alpha texture.
  /// </summary>
  public bool useAlphaTexture
  {
    get
    {
      if (mReplacement != null) return mReplacement.useAlphaTexture;
      if(mUseAlphaTexture == -1)
      {
        mUseAlphaTexture = (material != null && material.IsKeywordEnabled("USE_ALPHA_TEX")) ? 1 : 0;
      }
      return mUseAlphaTexture == 1;
    }
  }
  ...
  public Texture alphaTexture { get { return (mReplacement != null) ? mReplacement.alphaTexture : (material != null ? material.GetTexture("_AlphaTex") as Texture : null); } }
	/// <summary>
