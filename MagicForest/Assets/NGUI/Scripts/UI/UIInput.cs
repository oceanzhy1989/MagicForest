...
public class UIInput : MonoBehaviour
{
  ...
  public delegate bool OnPreValidate(string leftText, string rightTxt, string newText);
  ...
  public List<EventDelegate> onPreChange = new List<EventDelegate>();

  /// <summary>
  /// Event delegates triggered when the input field's text select for any reason.
  /// </summary>

  public List<EventDelegate> onSelect = new List<EventDelegate>();

  /// <summary>
  /// Event delegates triggered when the input field's text deselect for any reason.
  /// </summary>
  ...
  /// <summary>
  /// Custom prevalidation callback.
  /// </summary>

  public OnPreValidate onPreValidate;
...
#if MOBILE
	public TouchScreenKeyboard TouchKeyboard {get {return mKeyboard;}}
#endif
  [System.NonSerialized]
  ...
  public bool isSelected
  {
    ...
    set {
      if (!value) { if (isSelected) UICamera.selectedObject = null; } else UICamera.selectedObject = gameObject;
    }
  }
  ...
  protected virtual void Insert(string text)
  {
    ...
    if (onPreValidate != null && !onPreValidate(left, right, text)) {
      return;
    }
  ...
  /// <summary>
  /// Execute the OnPreChange callback.
  /// </summary>

  protected void ExecuteOnPreChange()
  {
    if (EventDelegate.IsValid(onPreChange)) {
      current = this;
      EventDelegate.Execute(onPreChange);
      current = null;
    }
  }
  ...
  protected void ExecuteOnDeselect()
  {
    if (EventDelegate.IsValid(onDeselect)) {
      current = this;
