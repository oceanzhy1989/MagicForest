...
public class UIPanelInspector : UIRectEditor
{
    ...
    //modified by liencheng
    UIPanelInspectorEx.PanelDepthQueue depthQueue = UIPanelInspectorEx.GetPanelDepthQueue(mPanel.depth);
    depthQueue = (UIPanelInspectorEx.PanelDepthQueue)EditorGUILayout.EnumPopup("DepthQueue",depthQueue);
      ...
      depth = UIPanelInspectorEx.GetFixedDepth(depthQueue, depth);
